...
if __name__ == "__main__":
    train_data_dir = join(base, "nnUNet_raw_splitted/Task00_DATASET/imagesTr")
    train_seg_dir = join(base, "nnUNet_raw_splitted/Task00_DATASET/labelsTr")
    test_dir = join(base, "nnUNet_raw_splitted/Task00_DATASET/imagesTs")


    output_folder = join(base, "nnUNet_raw_splitted/Task00_DATASET")
    ...
    nii_files_tr_data = [p for p in nii_files_tr_data if p.endswith('0000.nii.gz')]
    nii_files_ts =  [p for p in nii_files_ts if p.endswith('0000.nii.gz')]
