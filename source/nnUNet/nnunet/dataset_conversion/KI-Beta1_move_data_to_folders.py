...
if __name__ == '__main__':
    ...
    out_dir = '/home/woznicki/kidney/axial_nnUNet/base/nnUNet_raw_data/Task010_ProstateLesion/'
    ...
    for cohort in [('train', 'Tr'), ('test', 'Ts')]:
        for source in ['munich', 'mannheim']:
            ...
            for id_ in ids[cohort[0]][source]:
                ...
                matrix = (lesion_matrix > 0).astype('uint8')

                new_seg = nib.Nifti1Image(matrix, lesion_nifti.affine, lesion_nifti.header)
    ...
    df.to_csv('../lookup_df_prostate_lesion.csv')
